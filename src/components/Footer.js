      ...
      <div className="container mx-auto">
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
            <div className="mb-10 w-full">
              ...
              <p className="flex items-center text-sm font-medium text-dark">
                <span className="mr-3 text-brand-orange">
                  <svg
                    width="19"
                    height="21"
                    viewBox="0 0 19 21"
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div className="mb-10 w-full">
              <h4 className="mb-9 text-lg font-semibold text-dark">Rechtsthemen</h4>
              <ul>
                <li>
                  <a
                    href="javascript:void(0)"
                    className="mb-2 inline-block text-base leading-loose text-body-color hover:text-brand-orange"
                  >
                    Vertragsrecht
                  </a>
                </li>
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div className="mb-10 w-full">
              <h4 className="mb-9 text-lg font-semibold text-dark">Unternehmen</h4>
              <ul>
                <li>
                  <a
                    href="javascript:void(0)"
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div className="mb-10 w-full">
              <h4 className="mb-9 text-lg font-semibold text-dark">Schnellzugriff</h4>
              <ul>
                <li>
                  <a
                    href="javascript:void(0)"
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div className="mb-10 w-full">
              <h4 className="mb-9 text-lg font-semibold text-dark">Folgen Sie uns auf</h4>
              <div className="mb-6 flex items-center">
                <a
                  href="javascript:void(0)"
                  className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] text-dark hover:border-brand-orange hover:bg-brand-orange hover:text-dark sm:mr-4 lg:mr-3 xl:mr-4"
                >
                  <svg
                    width="8"
                    height="16"
              ...
              <p className="text-base text-body-color">&copy; 2023 Rechtschutz AG</p>
            </div>
          </div>
        </div>
      </div>
