        ...
        <div class="-mx-4 flex flex-wrap lg:justify-between">
          <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div class="mb-12 max-w-[570px] lg:mb-0">
              <span class="mb-4 block text-base font-semibold text-brand-orange">Kontakt</span>
              <h2 class="mb-6 text-[32px] font-bold uppercase text-dark sm:text-[40px] lg:text-[36px] xl:text-[40px] font-primary">
                Wir sind nur <br />
                einen Klick entfernt.
              </h2>
              <p class="mb-9 text-base leading-relaxed text-body-color">
                Wir bei Rechtsschutz AG setzen uns dafür ein, Ihnen den bestmöglichen Service zu
                bieten. Wenn Sie Fragen haben, Beratung benötigen oder mehr über unsere
                Dienstleistungen erfahren möchten, sind wir immer für Sie da.
                <br />
                <br />
                Für dringende Rechtsfälle außerhalb unserer Geschäftszeiten nutzen Sie bitte die
                Notrufnummer: +49 123 4567 892.
              </p>

              <div class="mb-8 flex w-full max-w-[370px]">
                <div class="mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-brand-yellow bg-opacity-95 text-dark  sm:h-[70px] sm:max-w-[70px]">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
                ...
                <div class="w-full">
                  <h4 class="mb-1 text-xl font-bold text-dark">Standort</h4>
              ...
              <div class="mb-8 flex w-full max-w-[370px]">
                ...
                <div class="w-full">
                  <h4 class="mb-1 text-xl font-bold text-dark">Telefon</h4>
                  <p class="text-base text-body-color">+49 123 4567 890</p>
                </div>
              </div>
              ...
              <div class="mb-8 flex w-full max-w-[370px]">
                ...
                <div class="w-full">
                  ...
                  <p class="text-base text-body-color">kontakt@rechtsschutz-ag.de</p>
                </div>
              </div>
            </div>
          </div>
